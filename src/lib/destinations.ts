...
export const DESTINATIONS: Record<string, DestinationData> = {
  // ── Destinos NACIONAIS primeiro (maior volume de busca do viajante BR e sem
  //    barreira de passaporte/câmbio). Reaproveitam o mesmo template. ──
  "rio-de-janeiro": {
    name: "Rio de Janeiro", country: "Brasil", flag: "🇧🇷",
    heroColor: "from-emerald-700 to-blue-900",
    highlight: "Sem passaporte · Praia + montanha · Cartão-postal do Brasil",
    description: "A Cidade Maravilhosa reúne praia, mata atlântica e alguns dos cartões-postais mais famosos do mundo. Roteiro clássico de 4 dias cobrindo o essencial sem correria.",
    bestTime: "Abril–Junho e Setembro–Novembro (menos chuva e menos lotado)",
    avgBudget: "R$ 300 – R$ 600/dia por pessoa",
    language: "Português",
    visa: "Só RG ou CNH (voo doméstico)",
    slug: "rio-de-janeiro",
    days: [
      { day: "Dia 1", title: "Cristo e Santa Teresa", activities: ["Cristo Redentor pelo trem do Corcovado (compre online e vá cedo)", "Almoço no Aprazível, em Santa Teresa", "Escadaria Selarón", "Pôr do sol no Parque das Ruínas"] },
      { day: "Dia 2", title: "Pão de Açúcar e Urca", activities: ["Bondinho do Pão de Açúcar (evite fila comprando online)", "Praia Vermelha e Pista Cláudio Coutinho", "Fim de tarde na mureta da Urca", "Jantar em Botafogo"] },
      { day: "Dia 3", title: "Praias da Zona Sul", activities: ["Copacabana e forte de Copacabana", "Ipanema (posto 9) e Arpoador para o pôr do sol", "Feira hippie de Ipanema (só domingos)", "Lagoa Rodrigo de Freitas de bike"] },
      { day: "Dia 4", title: "Centro histórico e Boulevard Olímpico", activities: ["Museu do Amanhã", "AquaRio", "Mural Etnias (Kobra) no Boulevard", "Real Gabinete Português de Leitura"] },
    ],
    tips: [
      "Cristo e Pão de Açúcar com ingresso online evitam horas de fila",
      "Use aplicativo de transporte à noite; combine praia de dia e passeios altos de manhã",
      "Deixe documentos e celular no hotel quando for só curtir a praia",
      "Verão (dez–mar) tem praia cheia e pancadas de chuva à tarde",
      "O bilhete único integra ônibus, metrô e VLT no centro",
    ],
  },
  "fernando-de-noronha": {
    name: "Fernando de Noronha", country: "Brasil", flag: "🇧🇷",
    heroColor: "from-teal-600 to-emerald-900",
    highlight: "Paraíso natural · Mergulho · Reserva protegida",
    description: "O arquipélago mais paradisíaco do Brasil: praias de água transparente, mergulho com tartarugas e golfinhos e trilhas em meio à natureza preservada. Caro, mas inesquecível.",
    bestTime: "Agosto–Dezembro (mar calmo e melhor visibilidade para mergulho)",
    avgBudget: "R$ 800 – R$ 1.500/dia por pessoa (a ilha é cara)",
    language: "Português",
    visa: "Só RG ou CNH · pague a Taxa de Preservação (TPA) e o ingresso do Parque Nacional",
    slug: "fernando-de-noronha",
    days: [
      { day: "Dia 1", title: "Chegada e mar de dentro", activities: ["Pague a TPA e o ingresso do Parque (válido 10 dias)", "Praia do Cachorro e Praia do Meio", "Pôr do sol no Forte dos Remédios", "Jantar na Vila dos Remédios"] },
      { day: "Dia 2", title: "Baía do Sancho e trilhas", activities: ["Baía do Sancho (eleita uma das mais bonitas do mundo)", "Mirante dos Golfinhos de manhã cedo", "Baía dos Porcos e Mirante Dois Irmãos", "Snorkel na piscina natural"] },
      { day: "Dia 3", title: "Mergulho e mar de fora", activities: ["Mergulho cilindro ou passeio de barco (reserve antes)", "Praia do Leão (desova de tartarugas)", "Atalaia (piscina natural — agende no ICMBio)", "Baía do Sueste com tartarugas"] },
      { day: "Dia 4", title: "Ilhatour e despedida", activities: ["Ilhatour de buggy pelos principais pontos", "Praia da Conceição e Boldró", "Compras de lembranças na Vila", "Último pôr do sol no Boldró"] },
    ],
    tips: [
      "Reserve hospedagem e voos com meses de antecedência — vagas são limitadas por lei",
      "A TPA aumenta por dia de permanência; calcule no orçamento",
      "Leve dinheiro: sinal de celular e internet são fracos e caixas eletrônicos, escassos",
      "Piscinas naturais (Atalaia) têm horário e agendamento controlados",
      "Protetor solar biodegradável é obrigatório em várias praias",
    ],
  },
  "gramado": {
    name: "Gramado", country: "Brasil", flag: "🇧🇷",
    heroColor: "from-rose-700 to-red-900",
    highlight: "Serra gaúcha · Clima europeu · Natal Luz",
    description: "A cidade mais charmosa da serra gaúcha: clima frio, arquitetura europeia, chocolate artesanal e o famoso Natal Luz. Ótima para casais e famílias, o ano inteiro.",
    bestTime: "Junho–Agosto (frio de verdade) e o Natal Luz (outubro–janeiro)",
    avgBudget: "R$ 400 – R$ 700/dia por pessoa",
    language: "Português",
    visa: "Só RG ou CNH (voo até Porto Alegre/Caxias + ~2h de carro)",
    slug: "gramado",
    days: [
      { day: "Dia 1", title: "Centro de Gramado", activities: ["Rua Coberta e Pórtico", "Lago Negro (pedalinho)", "Chocolate quente numa das chocolaterias", "Jantar de fondue"] },
      { day: "Dia 2", title: "Atrações e Canela", activities: ["Mini Mundo ou Snowland (neve indoor)", "Catedral de Pedra em Canela", "Parque do Caracol (cascata)", "Alpen Park ou Skyglass"] },
      { day: "Dia 3", title: "Vale e vinhos", activities: ["Vale dos Vinhedos (Bento Gonçalves)", "Degustação em uma vinícola", "Almoço colonial", "Compras de malhas e chocolates"] },
    ],
    tips: [
      "No Natal Luz, compre os ingressos dos espetáculos com antecedência",
      "Alugue um carro: as atrações ficam espalhadas entre Gramado, Canela e o Vale",
      "Junho–agosto é o auge do frio (leve casaco de verdade)",
      "Reserve os melhores restaurantes de fondue com dias de antecedência",
      "Hospedagem sobe muito de preço em julho e no Natal Luz",
    ],
  },
  "foz-do-iguacu": {
    name: "Foz do Iguaçu", country: "Brasil", flag: "🇧🇷",
    heroColor: "from-cyan-700 to-blue-900",
    highlight: "Cataratas · Tríplice fronteira · Itaipu",
    description: "Uma das sete maravilhas naturais: as Cataratas do Iguaçu vistas dos dois lados, mais a usina de Itaipu e a fronteira com Argentina e Paraguai. Dá para conhecer em 3 dias.",
    bestTime: "O ano todo; evite feriados prolongados pela lotação",
    avgBudget: "R$ 300 – R$ 500/dia por pessoa",
    language: "Português (espanhol na fronteira)",
    visa: "Só RG ou CNH no Brasil · leve documento para cruzar para Argentina",
    slug: "foz-do-iguacu",
    days: [
      { day: "Dia 1", title: "Cataratas (lado brasileiro)", activities: ["Parque Nacional do Iguaçu e a trilha das Cataratas", "Passarela da Garganta do Diabo", "Macuco Safari (bote sob as quedas — opcional)", "Parque das Aves ao lado"] },
      { day: "Dia 2", title: "Cataratas (lado argentino)", activities: ["Parque Nacional Iguazú (chegue na abertura)", "Trem ecológico e passarela da Garganta del Diablo", "Circuitos Superior e Inferior", "Volta a Puerto Iguazú"] },
      { day: "Dia 3", title: "Itaipu e fronteira", activities: ["Usina de Itaipu (visita panorâmica ou especial)", "Marco das Três Fronteiras ao pôr do sol", "Compras em Ciudad del Este (Paraguai)", "Templo Budista"] },
    ],
    tips: [
      "Reserve um dia para cada lado das Cataratas — os dois valem a pena e são diferentes",
      "Leve capa de chuva: você vai se molhar nas passarelas",
      "Para o lado argentino, confira a necessidade de documento/entrada e o câmbio",
      "Compre ingressos dos parques online para evitar filas",
      "Itaipu tem horários fixos de visita — agende antes",
    ],
  },
  "lisboa": {
